let pos = 0;
const pacArray = [
  ['./images/PacMan1.png','./images/PacMan1.png', './images/PacMan2.png', './images/PacMan2.png'],
  ['./images/PacMan3.png','./images/PacMan3.png', './images/PacMan4.png', './images/PacMan4.png'],
];
let direction = 0;
...
function update() {
  ...
  const btn = document.getElementById('btnStart').style.display='none';
  const btn2 = document.getElementById('btnRestart').style.display='inline-block';
...
function checkCollisions(item) {
  ...
  let ancho = window.innerWidth - item.newimg.width;
  let alto = window.innerHeight - item.newimg.height;
  if(item.position.x>=ancho){
  ...
  if(item.position.y>=alto || item.position.y<=0 ){
